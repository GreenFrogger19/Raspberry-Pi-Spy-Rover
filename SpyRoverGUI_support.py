...
#
# PAGE, Python Automatic GUI Generator, generated the skeleton code for this module (function names, imports, def init).
# I coded the functionality for all of the functions.
